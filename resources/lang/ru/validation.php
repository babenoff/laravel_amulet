...
return [
    ...
    */
    'custom'               => [
        ...
        'hero_name' => [
            'alpha_dash' => 'Неверный синтаксис в имени',
            'unique' => 'Это имя уже занято',
            'min' => 'Минимальная длина имени героя - 4 символа',
            'max' => 'Максимальная длина имени героя - 26 символов',
            'required' => 'Вы забыли назвать своего персонажа'
        ],
        'email' => [
